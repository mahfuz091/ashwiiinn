        ...
        <div className='md:grid md:grid-cols-2 md:gap-x-[42px] md:gap-y-[30px]'>
          <div className='form-control w-full'>
            ...
            <p className='mt-[14px] text-[13px] text-[#535353] font-normal'>
              Do you have more than on brand? Contact sales@leaflink.com to
              learn how to make them stand out for Leaflink shoppers.
            </p>
          </div>
          <div className='form-control w-full'>
            ...
            <p className='mt-[14px] text-[13px] text-[#535353] font-normal w-full'>
              Associate a product line with product. Your shop brand page will
              group together products in the same product line.
            </p>
            <p className='mt-[11px] text-[15px] text-[#6BCB77] font-medium'>
          ...
          <div className='form-control col-span-2 relative bg-[#442862] rounded-md py-[18px] pl-[21px] pr-[32px] md:pr-[125px] '>
            <h2 className=' text-[13px] text-[#fff] font-normal leading-[23px]'>
              Buyers will have a choice of package sizes, flavors, or stains
              when shopping this product. The values you enter will
              automatically populate to all varieties , except where you
            ...
            <div className='absolute top-2 right-2'>
              ...
              >
                ...
                <path
                  d='M10.4297 10.5566L17.7853 17.9123'
                  stroke='white'
                  strokeLinecap='round'
                />
                <path
                  d='M17.7852 10.5566L10.4295 17.9123'
                  stroke='white'
                  strokeLinecap='round'
                />
              </svg>
          ...
          <div className='form-control w-full'>
            ...
            <p className='mt-[14px] text-[13px] text-[#535353] font-normal'>
              Cannabis and cannabis infused products must have an associated
              License.
            </p>
          </div>
        </div>
