    ...
    <div className='py-[37px] border-b-[1px] border-b-[#DBDBDB] last:border-none flex flex-col sm:flex-row justify-between sm:items-center gap-4'>
      <div className='flex flex-col md:flex-row md:items-center gap-[26px]'>
        ...
        <div className='max-w-[373px]'>
          ...
          <p className='mb-[27px]'>
            <span className='line-through text-[17px] text-[#535353] font-normal mr-[12px]'>
              ${product.price}
            </span>{" "}
            <span className=' text-[20px] text-[#000] font-medium'>
              ${product.discountPrice}/Unit
            </span>{" "}
            <span className='text-[20px] text-[#535353] font-normal'>
              (${product.discountPrice}/gram)
            </span>
          </p>
          <div className='flex items-center gap-[16px]'>
            <p className='text-[17px] text-[#000] font-medium'>
              Strain<span className='ml-[10px]'>{product.strain}</span>
            </p>{" "}
            <span>
              <svg
            ...
            <p className='text-[17px] text-[#000] font-medium'>
              Staiva<span className='ml-[10px]'>{product.staiva}%</span>
            </p>
          </div>
        </div>
      </div>
      <div>
        <div className='flex  w-[201px] items-center gap-[37px] p-2 border-[2px] border-[#6BCB77] rounded-[42px]'>
          ...
          >
            ...
            >
              <path
                d='M1.57227 6.76685H12.6172'
                stroke='white'
                stroke-width='2.5'
                stroke-linecap='round'
              />
              <path
                d='M7.09473 1.24438L7.09473 12.2893'
                stroke='white'
                stroke-width='2.5'
                stroke-linecap='round'
              />
        ...
        <div>
          <button className='w-[201px] rounded-[42px] py-[18px] bg-[#DCDCDC] mt-[23px] text-[#535353] text-[15px] font-normal '>
            Notes
          </button>
        </div>
      </div>
